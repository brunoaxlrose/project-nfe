                        ...
                        <div class="grid gap-x-5 gap-y-4 md:grid-cols-2">
                            ...
                            <label><span class="label">CPF / CNPJ</span>
                                <input x-model="cliente.documento" 
                                       x-mask.dynamic="cliente.documento && cliente.documento.replace(/\D/g, '').length > 11 ? '99.999.999/9999-99' : '999.999.999-99'"
                                       @input="if(cliente.documento && cliente.documento.replace(/\D/g, '').length === 14) consultarDocumento()" 
